...
export default function Hero() {
  return (
    <section className="px-4 pt-4 pb-8">
      <div
        className="grain relative overflow-hidden rounded-[2.5rem] flex flex-col min-h-[580px] md:min-h-[640px] lg:h-[72vh] lg:min-h-[660px]"
      ...
      >
        ...
        <div className="relative flex flex-col flex-1" style={{ zIndex: 1 }}>
          ...
          {/* Main content */}
          <div className="flex-1 flex items-center px-6 lg:px-14 xl:px-20 pt-10 lg:pt-16 xl:pt-20">
            {/*
              < lg  (mobile + tablet portrait): flex-col, centralizado, sem mockup
              >= lg (tablet landscape + desktop): flex-row, lado a lado, com mockup
            */}
            <div className="w-full flex flex-col lg:flex-row items-center gap-8 lg:gap-10 xl:gap-16">
              ...
              <div className="flex-1 min-w-0 w-full text-center lg:text-left">
                ...
                <h1
                  className="text-[1.9rem] sm:text-4xl md:text-5xl lg:text-[3rem] xl:text-[4.5rem] font-bold text-white leading-[1.1] mb-3 lg:mb-4"
                ...
                >
                  <Typewriter
                    ...
                    loop={true}
                    cursor="_"
                    className="text-lg md:text-xl lg:text-lg xl:text-2xl font-light text-white/70 tracking-tight"
                  />
                </div>
              ...
              {/*
                Mockup: oculto abaixo de lg (mobile + tablet portrait)
                        visível em lg+ (tablet landscape + desktop)
              */}
              <div
                className="shrink-0 w-full hidden lg:flex justify-center lg:w-auto xl:block pb-2 lg:pb-0"
                style={{ animation: 'var(--animate-fade-in-up-d2)' }}
              >
          ...
          {/* Stats bar */}
          <div
            className="px-6 lg:px-14 xl:px-20 py-5 shrink-0"
            style={{
            ...
            <div className="flex items-center justify-center lg:justify-start">
              {stats.map((stat, i) => (
                <div key={stat.metric} className="flex items-center">
                  <div className="pr-4 sm:pr-6 lg:pr-10 xl:pr-16">
                  ...
                  {i < stats.length - 1 && (
                    <div className="w-px h-7 lg:h-10 bg-white/10 mr-4 sm:mr-6 lg:mr-10 xl:mr-16 shrink-0" />
                  )}
                </div>
              ))}
            </div>
