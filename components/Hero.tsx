...
export default function Hero() {
  return (
    <section className="px-4 pt-4 pb-8">
      <div
        className="grain relative overflow-hidden rounded-[2.5rem] flex flex-col min-h-[580px] md:h-[72vh] md:min-h-[620px] lg:min-h-[660px]"
          ...
          <div className="flex-1 flex items-center px-6 lg:px-14 xl:px-20 pt-10 lg:pt-16 xl:pt-20">
            <div className="w-full flex flex-col lg:flex-row items-center gap-8 lg:gap-10 xl:gap-16">
              ...
              <div
                ...
                style={{ animation: 'var(--animate-fade-in-up-d2)' }}
              >
                <div className="relative w-full max-w-[280px] sm:max-w-[340px] lg:max-w-[320px] xl:max-w-none">
                  <div
                    style={{
            ...
            <div className="flex items-center">
              {stats.map((stat, i) => (
                <div key={stat.metric} className="flex items-center">
                  <div className="pr-4 sm:pr-5 lg:pr-8 xl:pr-16">
                  ...
                  {i < stats.length - 1 && (
                    <div className="w-px h-7 lg:h-10 bg-white/10 mr-4 sm:mr-5 lg:mr-8 xl:mr-16 shrink-0" />
                  )}
                </div>
              ))}
            </div>
