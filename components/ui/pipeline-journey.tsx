...
const COLUMNS = [
  { id: "briefing",      title: "Briefing",       count: 3 },
  { id: "dev",           title: "Desenvolvimento", count: 2 },
  { id: "entregue",      title: "Entregue",        count: 4 },
];
...
export function PipelineJourney({
  ...
  return (
    ...
    >
      ...
      {COLUMNS.map((col, i) => {
        const flash =
          col.id === "dev"      ? progFlash :
          col.id === "entregue" ? doneFlash : 0;
        return (
          <div
            key={col.id}
            style={{
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ fontFamily: MONO_FAMILY, fontSize: 11, opacity: 0.5 }}>
            AB3-001
          </div>
          <div
            style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "auto" }}>
          ...
          <div style={{ fontSize: 11, opacity: 0.4 }}>ab3design</div>
        </div>
      </div>
      ...
      {confettiFrame > 0 &&
        Array.from({ length: PARTICLE_COUNT }).map((_, i) => {
          ...
          const color    =
            colorPick < 0.33 ? accentColor :
            colorPick < 0.66 ? "#fbbf24"   : "#60a5fa";
          const lifespan = 50;
