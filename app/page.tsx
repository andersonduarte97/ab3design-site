          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
              ...
              <div>
                ...
                <p className="text-[#94A3B8] font-light text-lg mb-3">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a
                    ...
                    className="group inline-flex items-center gap-3 rounded-full pl-6 pr-2 py-2 hover:scale-105 transition-transform duration-300 self-start"
                    style={{ background: '#25D366' }}
                  >
                    <span className="font-medium text-sm text-white">Chamar no WhatsApp</span>
                    <span className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.18)' }}>
                  ...
                  <a
                    ...
                    className="group inline-flex items-center gap-3 rounded-full pl-6 pr-2 py-2 border border-white/10 hover:border-white/20 hover:scale-105 transition-all duration-300 self-start"
                    style={{ background: 'rgba(255,255,255,0.04)' }}
                  >
                    <span className="font-medium text-sm text-white/70 group-hover:text-white transition-colors duration-200">
                      oi@ab3design.com.br
                    </span>
                    <span className="w-10 h-10 rounded-full flex items-center justify-center" style={{ background: '#09090B' }}>
